...
public final class GMACommand {
    ...
    public void register(final Commands registrar) {
        final var command = Commands.literal("gma")
        ...
        registrar.register(command, "Set your game mode to Adventure");
    }
    ...
    private int gamemodeOther(final CommandContext<CommandSourceStack> context) throws CommandSyntaxException {
        ...
        return this.plugin.getPlayerController().setGameMode(sender, GameMode.ADVENTURE, resolver.resolve(context.getSource()));
    }
    ...
    private int gamemodeSelf(final CommandContext<CommandSourceStack> context) {
        ...
        if (sender instanceof Player player) {
            return this.plugin.getPlayerController().setGameMode(sender, GameMode.ADVENTURE, List.of(player));
        }
