...
// Command class for the /gmc command
...
public final class GMCCommand {
    ...
    public void register(final Commands registrar) {
        final var command = Commands.literal("gmc")
        ...
        registrar.register(command, "Set your game mode to Creative");
    }
    ...
    private int gamemodeOther(final CommandContext<CommandSourceStack> context) throws CommandSyntaxException {
        ...
        return this.plugin.getPlayerController().setGameMode(sender, GameMode.CREATIVE, resolver.resolve(context.getSource()));
    }
    ...
    private int gamemodeSelf(final CommandContext<CommandSourceStack> context) {
        ...
        if (sender instanceof Player player) {
            return this.plugin.getPlayerController().setGameMode(sender, GameMode.CREATIVE, List.of(player));
        }
